 ...
 * \file pwm.c 
 *
 * \brief This file generates Pulse Width Modulation (PWM) using fast mode in Pins PD5 and PD6
 *
 * \author 
...
int main( void ){
  ...
  OCR0A = 192;         // PWM active cycle control (OC0A - PD6) --> duty cycle = 192/256 = 75%
  OCR0B = 64;          // PWM active cycle control (OC0B - PD5) --> duty cycle =  64/256 = 25%
